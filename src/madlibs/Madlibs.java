...
//        Print instructions to player
        public void printInstructions(){
            System.out.println("Welcome to the MadLibs game. If you type in words, we''l give you a story. "
...
//        Get data from player
        ...
        public void putTogetherTheStory(){
            ...
            story = "Jesse and her best friend" + getName() + "went to Disney World today! "
                    +"They saw a "+ getNoun1() + "in a show at the Magical Kingdom" +
                ...
                story = "Amanda and her friend and " + getName() + "went to the zoo last summer."+ 
